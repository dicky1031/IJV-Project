...
python .\S1_make_simarr.py --num_skin_mus $num_skin_mus --num_fat_mus $num_fat_mus --num_muscle_mus $num_muscle_mus --num_blood_mus $num_blood_mus --num_skin_mus $num_skin_mua --num_fat_mua $num_fat_mua --num_muscle_mua $num_muscle_mua --num_ijv_mua $num_ijv_mua --num_cca_mua $num_cca_mua
echo "################################### finish S1 ################################################"
...
python .\S2_make_simfile.py --root $root --subject $subject --date $data --PhotonNum $PhotonNum --VoxelSize $VoxelSize --NA $NA
echo "################################### finish S2 ################################################"
